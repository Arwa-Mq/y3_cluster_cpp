...
def full_ltmz_mass_integral_adaptive(bins, mor, plob_splines, hmf, dv, *,
    ...
    Same contract as full_ltmz_mass_integral_quad (adaptive outer mass
    ...
    scipy.integrate.quad (see the full_ltmz READMEs).
...
def full_ltmz_mass_integral_quad(bins, mor, plob_splines, hmf, dv, *,
                                 sci=None, profile=None, r_perp=None,
                                 zt_low, zt_high, lnm_low, lnm_high,
